...
/*Webots 2018b*/
#define FLOCK_SIZE	      3  // Size of flock (2,3,4 or 5) of one group
...
void process_received_ping_messages(void) {
    ...
    while (wb_receiver_get_queue_length(receiver) > 0) {
          ...
          if ((robotID_in_group1(robot_id_u) && (friend_robot_id == LEADER1_ID)) || 
              (!robotID_in_group1(robot_id_u) && (friend_robot_id == LEADER2_ID))){
              x_to_leader = x;
          }
