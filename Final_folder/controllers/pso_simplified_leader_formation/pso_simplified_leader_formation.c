/*****************************************************************************************************************************/
/* File:         pso_simplified_leader_formation.c                                           */
/* Version:      1.0                                                           */
/* Date:         01-Mai-21                                                     */
...
#define SIM_STEPS 1200       // Number of simulation steps/iterations (Change it also in Leader)
...
static pose_t _pose_origin = {0, 0.0, 0.0};
// Migration target
