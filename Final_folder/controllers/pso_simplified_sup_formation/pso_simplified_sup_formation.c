/*****************************************************************************************************************************/
/* File:         pso_simplified_sup_formation.c                                           */
/* Version:      1.0                                                           */
/* Date:         01-Mai-21                                                     */
...
/* PSO definitions */
#define NB_PARTICLE 8                   // Number of particles in swarm
#define MIN_WEIGHT_P 10                 // Minimum of a particles weight/threshold for one of P's rule
...
#define VMAX 20.0                       // Maximum velocity of particles by default
...
double prior_knowledge[DATASIZE] = {1800, 70,            // avoidance threshold, formation threshold
